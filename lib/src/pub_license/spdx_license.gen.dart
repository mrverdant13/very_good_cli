...
enum SpdxLicense {
  ...
  $Brian_Gladman_3_Clause_no_conversion._(
  ...
  $FSFUL._('FSFUL'),
  $FSFULLR._('FSFULLR'),
  $FSFULLRSD._('FSFULLRSD'),
  $FSFULLRWD._('FSFULLRWD'),
  $FSL_1_1_ALv2._('FSL-1.1-ALv2'),
  $FSL_1_1_MIT._('FSL-1.1-MIT'),
  $FTL._('FTL'),
  $Fair._('Fair'),
  ...
  $Game_Programming_Gems._('Game-Programming-Gems'),
  $Giftware._('Giftware'),
  $Glide._('Glide'),
  $Glulxe._('Glulxe'),
